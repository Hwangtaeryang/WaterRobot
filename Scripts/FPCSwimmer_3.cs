...
{
    public class FPCSwimmer_3 : MonoBehaviour
    {
        ...
        public float underwaterSpeed = 1f;//3.0f;
        ...
        public float runMultiplicator = 1f;
        ...
        public float playerSpeed = 0;//2.0f;
        ...
        public float speed_copy;   //속도 text에 넣기 위해 복사본 변수
        ...
        private bool CalculateNewPosition(bool isSwimming)
        {
            ...
            if (isSwimming)
            {
                ...
                // Calculate external forces influencing the player's motion
                {
                    ...
                    playerSpeed = playerSpeed * currentSpeed;
                    speed_copy = playerSpeed;   //복사본
                    //Debug.Log("underwaterSpeed " + underwaterSpeed + " runMultiplicator " + runMultiplicator);
